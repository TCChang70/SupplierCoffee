package model;
// Generated 2020�~11��17�� �U��4:03:09 by Hibernate Tools 5.4.21.Final
...
public class Suppliers implements java.io.Serializable {
	...
	public Suppliers(int supId, String supName, String street, String city, String state, String zip, Set<Coffees> coffeeses) {
		this.supId = supId;
		this.supName = supName;
		this.street = street;
		this.city = city;
